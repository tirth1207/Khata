...
function Metric({label,value,tone}:{label:string;value:string;tone?:'income'|'expense'}){return <View style={{flex:1,marginTop:20}}><Text style={ui.small}>{label}</Text><Text style={[ui.amount,{marginTop:3,color:tone==='income'?palette.income:tone==='expense'?palette.expense:palette.primaryText}]}>{value}</Text></View>;}
