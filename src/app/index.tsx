...
const s=StyleSheet.create({hero:{marginTop:18,backgroundColor:'#111113',borderColor:'#111113'},heroLabel:{fontSize:11,fontWeight:'800',letterSpacing:.7,color:'#A7A7AD'},balance:{fontSize:38,fontWeight:'700',letterSpacing:-1.4,color:'#FFF',marginTop:4},big:{fontSize:25,fontWeight:'700',color:palette.text,marginTop:3},dot:{width:9,height:9,borderRadius:5,marginRight:10},icon:{width:36,height:36,borderRadius:12,alignItems:'center',justifyContent:'center',marginRight:11},name:{fontSize:15,fontWeight:'700',color:palette.text},emptyTitle:{fontSize:17,fontWeight:'700',color:palette.text}});
